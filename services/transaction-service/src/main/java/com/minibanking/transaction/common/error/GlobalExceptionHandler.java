package com.minibanking.transaction.common.error;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ProblemDetail> handleConflict(Exception exception, HttpServletRequest request) {
        String detail = exception instanceof ConflictException
                ...
                : "The request conflicts with existing transaction data";
        return response(HttpStatus.CONFLICT, "Transaction conflict", detail, request);
    }
